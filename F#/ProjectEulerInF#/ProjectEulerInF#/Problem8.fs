...
//taken from http://stackoverflow.com/questions/20308875/remove-characters-from-string-in-f
...
let stripChars = ""
let stringStrip = stripv3 stripChars string
let lenght2 = String.length stringStrip
